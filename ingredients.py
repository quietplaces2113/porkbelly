...
class Ingredients(Enum):
    ...
    LETTUCE = Ingredient('lettuce', Aisles.PRODUCE)
    ...
    BACON = Ingredient('bacon', Aisles.MEAT)
    ...
    OLIVE_OIL = Ingredient('olive oil', Aisles.SPICES)
    ...
    RED_WINE_VINEGAR = Ingredient('red wine vinegar', Aisles.SPICES)
    ...
    BREAD = Ingredient('bread', Aisles.PANTRY)
